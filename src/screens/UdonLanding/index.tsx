					...
					<div className="row">
						<div className="col-md-12 d-flex">
							<div className="action-start">
								...
								<a href="https://t.me/Wang_Jung_Udon" target="_blank" rel="noopener noreferrer">
									{intl.formatMessage({ id: 'landing.banner.content.header.startnow' })}
								</a>
							</div>
							<a className="action-view" href="https://test.udonex.com" target="_blank" rel="noopener noreferrer">
