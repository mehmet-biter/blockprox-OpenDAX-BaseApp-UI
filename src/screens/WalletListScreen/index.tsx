	...
	return (
		<div className="my-3 td-pg-wallets-screen">
			<div className="container-fluid">
				...
				<div
					className="td-pg-wallets-screen__body"
					style={[...walletCoinList].length > 0 ? {} : { paddingBottom: '150px' }}
				>
					<div className="row">
						...
						<div className="col-12">
							<Tabs defaultActiveKey="Crypto">
								<TabPane tab={intl.formatMessage({ id: 'page.body.plugins.wallet.tab.crypto' })} key="Crypto">
									<div className="col-12">{renderWalletCoinListTable()}</div>
								</TabPane>
								<TabPane tab={intl.formatMessage({ id: 'page.body.plugins.wallet.tab.fiat' })} key="Fiat">
									<div className="col-12">{renderWalletFiatListTable()}</div>
								</TabPane>
							</Tabs>
						</div>
					</div>
