...
export const IdentifyVerification = (props: IdentifyVerificationProps) => {
	...
	return (
		<div className="identify-verification">
			<div className="identify-verification__form">
				<h2 className="mb-5">{intl.formatMessage({ id: 'kyc.screen.IdentifyVerification.heading' })}</h2>
			</div>
			<div className="mt-3">
				<div className="form-group">
					<label className="text-white" htmlFor="name">
						{`${_startCase(documentType)} Number`}
					</label>
					<input
						autoFocus
						type="text"
						...
						placeholder={`Enter your ${_startCase(documentType)} number`}
					/>
				</div>
			</div>
			<div className="identify-verification__document-photo-type">
