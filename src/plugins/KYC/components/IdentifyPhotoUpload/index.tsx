...
export const IdentifyGovernment = (props: IdentifyGovernmentProps) => {
	...
	return (
		<div className="identify-photo-upload">
			<div className="identify-photo-upload__form">
				<h2 className="mb-5">{intl.formatMessage({ id: 'kyc.screen.IdentifyGovernment.heading' })}</h2>
			</div>
			<div className="identify-photo-upload__card">
				<div className="row">
			...
			<div className="identify-photo-upload__card-require">
			...
			<div className="identify-photo-upload__photo">
